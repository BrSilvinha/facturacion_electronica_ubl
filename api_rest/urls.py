# api_rest/urls.py - VERSIÓN COMPLETA ACTUALIZADA CON ESCENARIOS DE PRUEBA

"""
URLs para la API REST de Facturación Electrónica
VERSIÓN COMPLETA con endpoints de documentos, CDR y ESCENARIOS DE PRUEBA
"""
...
# 🧪 IMPORTAR VIEWS DE ESCENARIOS DE PRUEBA
...
urlpatterns = [
    ...
    # =========================================================================
    # 🧪 ENDPOINTS DE PRUEBA PARA NUBEFACT - NUEVOS
    # =========================================================================
